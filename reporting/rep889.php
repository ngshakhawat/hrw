...
function get_payslip_allocated_advances($payslip_no) {
	...
	$result = db_query($sql, 'could not get employee allocations amount');
	$row = db_fetch($result);
...
if($comp_logo)
	...
	$logo_path = $path_to_root . '/themes/default/images/ngiconerp.png';
